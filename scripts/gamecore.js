...
export class GameCore {
  ...
  async initialize() {
    ...
    // 🔥 ALWAYS use fresh new game state (from gameSettings)
    this.resetGameState();
    ...
    console.log("Initial runtime gameState:", this.gameState);
